...
function HeroSection() {
  return (
    <div className="flex flex-col  items-center mt-6 md:mt-20 ">
      <h1 className="text-4xl text-center px-4  mx-6 mt-20 tracking-wide md:text-7xl">
      ...
      <p className="text-center text-neutral-500 text-lg mx-9 mt-10 md:mx-16">
      ...
      <div className="flex mt-20 justify-center  mx-5">
      <video
          autoPlay
          loop
          muted
